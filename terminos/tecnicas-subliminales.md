...
Conviene fijarse en la estructura de la prohibición, porque de ella depende su alcance real. Hacen falta tres elementos acumulativos: una técnica manipuladora, una alteración sustancial del comportamiento y un perjuicio considerable —basta que sea razonablemente probable, no hace falta que se haya producido—. Y no se exige intención: el Reglamento dice «el objetivo **o el efecto**», de modo que un diseño que manipule sin proponérselo entra igual.

La autoridad neerlandesa dedicó a estas dos letras su [primer llamamiento a aportaciones](https://www.autoriteitpersoonsgegevens.nl/en/themes/algorithms-ai) precisamente porque la frontera con la publicidad persuasiva lícita y con los patrones oscuros ya regulados por otras normas es el punto más difícil de trazar.
